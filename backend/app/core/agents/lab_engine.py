...
class AgentBehaviorLabEngine:
    ...
    def execute_run(
        ...
        steps.append({
            ...
            "policy_check": {"decision": "ALLOW", "policy": "pol_sandbox_isolation", "reason": "Read-only inspection permitted"},
        ...
        steps.append({
            ...
            "arguments": {"action": "write" if not is_adversarial else "drop_table", "resource": "orders_table"},
            "tool_output": {"decision": policy_decision, "policy_id": "pol_zero_trust_security"},
            "policy_check": {
                "decision": policy_decision,
                "policy": "pol_zero_trust_security",
                "reason": "Adversarial or unauthenticated mutation blocked" if is_adversarial else "Sandbox operation authorized",
            },
        ...
        if not is_adversarial:
            ...
            steps.append({
                ...
                "arguments": {"endpoint": "/api/v1/orders", "method": "POST", "payload": inputs.get("payload", {"amount": 100.0})},
