...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('repository_id', mysql.CHAR(36), sa.ForeignKey('repositories.id', ondelete='CASCADE'), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column('repository_id', mysql.CHAR(36), sa.ForeignKey('repositories.id', ondelete='SET NULL'), nullable=True),
