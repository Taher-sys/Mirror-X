...
export function TopBar({ onOpenCommandPalette }: TopBarProps) {
  return (
    <header className="relative z-10 m-3 mb-0 flex h-16 items-center justify-between rounded-2xl border-2 border-orange-500/40 border-t-2 border-white/30 bg-zinc-950/85 px-6 backdrop-blur-3xl shadow-[0_20px_50px_rgba(0,0,0,0.9)]">
      <div className="flex items-center gap-6">
        ...
        >
          ...
          <span className="text-[11px] font-bold tracking-tight">Command search or jump to...</span>
