      ...
      {findings.length === 0 ? (
        ...
        <div className="space-y-2.5">
          {filtered.slice(0, 5).map((finding) => (
            <div
              key={finding.id}
              className="flex items-start justify-between gap-3 rounded-lg bg-[#12151e]/92 backdrop-blur-md border border-[#232736] border-t border-t-zinc-700/50 p-3.5 transition-all duration-300 ease-out hover:-translate-y-1.5 hover:scale-[1.01] hover:border-amber-500/50 hover:border-t-zinc-400 hover:shadow-[0_16px_40px_0_rgba(0,0,0,0.8)] shadow-[0_8px_32px_0_rgba(0,0,0,0.6)] cursor-pointer"
            >
